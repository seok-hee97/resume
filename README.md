...
담당업무: ML 연구 / 업무자동화 개발
- **BERT 기반 랜섬웨어 분석·분류 시스템 개발** (R&D 과제, 이진분류 91.64% / F1-Score 0.95, 복호화 F1-Score 0.93)
- **사내 악성코드 탐지 서비스(TTSC) 운영·개선** — EMBER 기반 탐지 모델 설계·구현(.NET PE 파싱 개선 2%p↑), 악성코드 350-400만 데이터셋 구축 및 Calibration으로 신뢰도 향상
- **VT 메타데이터 검색 시스템 개발** (사내 VirusTotal 대체, 일 10-15만 건 처리)
- **16종 인스톨러 자동 설치 시스템 구축**(88% 수집)으로 그레이 샘플 자동 확보
...
- 악성코드 분석 및 ML 탐지 엔진 운영 및 사내 세미나 진행 (상시)
