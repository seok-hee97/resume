...
- 아키텍처 : Nginx (SSL / Reverse Proxy) → FastAPI (Backend) + React SPA (Frontend), 3중 데이터 소스 (MySQL 5.6.40 / Elasticsearch 8.17 / Legacy MySQL 읽기전용), Docker Compose 5-서비스 배포.
- Skills: Python, FastAPI, React 18, TypeScript, Vite, MySQL, Elasticsearch, Nginx, Docker Compose, ECharts, SFTP
